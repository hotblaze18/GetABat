...
export const Testimonials = () => {
  ...
  const TestimonialsContent = [
    {
      content:
        "Exceptional quality, unparalleled performance, and unwavering durability - this is what defines GetABat. As an avid cricketer, I've had the privilege of experiencing their top-notch equipment firsthand, and I can confidently say that it's a game-changer.",
      name: 'Deep Rajgor',
      img: '/images/testimonials/person-1.jpeg',
          ...
          <SwiperSlide key={name} virtualIndex={index}>
            <div className={'space-y-10'}>
              ...
              <div className={'mx-auto max-w-max'}>
                <iframe src={driveLink} className={'w-[60vw] max-w-[600pc] max-h-[480px] h-[40vw]'} allow="autoplay" />
              </div>
            </div>
          </SwiperSlide>
        ))}
